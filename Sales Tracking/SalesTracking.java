...
public class SalesTracking
	...
	public static void main(String[] args)
	{
		...
		lowestSalesMonth = FindLowestMonth(monthlySales, lowestSales, monthArray);
	...
	{ 
		...
		try
		{
			...
			{
				System.out.println("Please enter total sales for " + monthArray[i] + ":");
	...
	public static String FindLowestMonth(double monthlySales[], double lowestSales, String[] monthArray)
	{ int i;
	...
	{ //This method receives the monthly sales array as an argument.
		//it then searches and compare the values of the monthly sales array for the lowest value.
		//and returns the index(i) of the month with the lowest value.
		int j;
		double lowvalue = 999999999;
	...
	public static void displayInfo(double totalSales, double averageSales, double highestSales, double lowestSales,
								String highestSalesMonth, String lowestSalesMonth)
	{//This method receives the total yearly sales, average monthly sale,
		//the month with the highest sales,as well as the sale for that month and
		//the month with the lowest sales then displays all the data it received as arguments.
		...
		System.out.print("Average annual sales: " + formatter.format(totalSales) + "\n");
		System.out.print("The first Month with the Highest annual sales was " + highestSalesMonth + " with " + formatter.format(highestSales)+ 
				" in sales" + "\n");
		System.out.print("The first Month with the lowest annual sales was " + lowestSalesMonth + " with " + formatter.format(lowestSales) +
				" in sales" + "\n");
	}
